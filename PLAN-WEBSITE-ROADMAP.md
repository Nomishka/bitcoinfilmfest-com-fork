...
**Latest implementation pass (2026-09-16):** the archive/current edition visual pass is complete and live after PR #12 merged to `main` at `4635bce`. Full BFF’23 (554) and BFF’25 (152) albums remain public and lazy-loaded, but are closed behind native disclosure controls; BFF’27 received a scoped hero/token polish. Build, GitHub Pages deployment, and HTTPS route QA pass.
